...
milks.forEach(milk => {
  ...
  return { name: coffee.name, description: coffee.description, price: coffee.price, caffeine:coffee.caffeine, rating:coffee.rating, image:coffee.image, element: card }
})
